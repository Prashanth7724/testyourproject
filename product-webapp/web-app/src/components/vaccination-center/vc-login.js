...
function VCLogin() {
    ...
    const onSubmit = user => {
        ...
        fetch('http:// 3.128.192.112:8080/authentication-service/api/v1/login', requestOptions)
            .then((result) => {
                    if (result.status === 200) {
                        ...
                        fetch('http:// 3.128.192.112:8080/user-service/api/v1/vaccination-center/specific/'+user.userEmail, requestOptions1).then((res)=>{
                            if(res.status==200){
